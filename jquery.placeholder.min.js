...
(function(e){e.fn.placeholder=function(f){var g=this,f=e.extend({force:!1},f);window.setTimeout(function(){(!("placeholder"in document.createElement("input"))||f.force)&&g.each(function(){var b=e(this),a=this.tagName.toLowerCase();if("input"===a||"textarea"===a)if(a=e(this).attr("placeholder")||"",a.length){var c=e("<span>").addClass("placeholder").html(a);b.data("placeholder",a);b.removeAttr("placeholder");for(var a="-moz-box-sizing -webkit-box-sizing box-sizing padding-top padding-right padding-bottom padding-left margin-top margin-right margin-bottom margin-left border-top-width border-right-width border-bottom-width border-left-width line-height font-size font-family width height top left right bottom".split(" "),
